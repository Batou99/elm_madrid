...
Elm.Main.make = function (_elm) {
   ...
   _U.list([]),
   _U.list([A2($Html.a,
   _U.list([$Html$Attributes.href("https://github.com/Batou99/elm_madrid")]),
   _U.list([$Html.text("Generador de temarios")]))]));
   var pageHeader = A2($Html.h1,
   _U.list([]),
   _U.list([$Html.text("Temario")]));
   var main = A2($Html.div,
   _U.list([$Html$Attributes.id("container")]),
   _U.list([pageHeader,pageFooter]));
