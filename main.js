...
var _user$project$Main$pageFooter = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$href('https://github.com/Batou99/elm_madrid')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Generador de temarios')
				]))
		]));
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('sort left'),
						_elm_lang$html$Html_Events$onClick(_user$project$Main$SortByTitulo)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(_user$project$Main$SortByDuracion)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Duracion')
					])),
				_user$project$Main$capitulos(model),
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{
			model: A2(_user$project$Main$update, _user$project$Main$SortByTitulo, _user$project$Main$modeloInicial),
